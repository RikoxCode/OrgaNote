...
<template>
  <div class="relative h-full w-full">
    ...
    >
      ...
      <div class="mb-2 p-4">
        <RouterLink to="/" class="text-2xl font-bold text-gray-700 dark:text-gray-300">
          {{ title }}
        </RouterLink>
      </div>
      ...
      <div class="flex flex-col justify-between h-[85%] overflow-scroll">
        <div>
          <div>
            ...
            >
              ...
              <Icon icon="chevron_right" class="h-4 w-4 mb-2 transition-transform" :class="{ 'rotate-90': isAccordionOpen }" />
            </button>
            ...
            <div v-if="isAccordionOpen" class="flex-col pl-6">
              <RouterLink
                  ...
                  :class="{ 'text-blue-400 font-bold': activeTab === '/club' }"
              >
        ...
        <div v-if="token">
          <RouterLink
              ...
              :class="{ 'text-blue-400 font-bold': activeTab === '/profile' }"
          >
            <ProfileImage :src="user.avatar.data" alt="profile image" class="h-6 w-6 rounded-full shadow-xl" />
          ...
          <RouterLink
              to="/settings"
              class="flex items-center p-3 hover:bg-gray-200 rounded-lg cursor-pointer dark:text-gray-300 dark:hover:bg-gray-800"
              :class="{ 'text-blue-400 font-bold': activeTab === '/settings' }"
          >
            <Icon icon="settings" />
        ...
        <div v-else>
          <RouterLink
              to="/login"
              class="flex items-center p-3 hover:bg-gray-200 rounded-lg cursor-pointer dark:text-gray-300 dark:hover:bg-gray-800"
              :class="{ 'text-blue-400 font-bold': activeTab === '/login' }"
          >
            <Icon icon="login" />
